...
module ZeroPush
  class Client
    ...
    def notify(params)
      response = http.post('/notify', params)
    ...
    def register(device_token, channel=nil)
      ...
      puts "enters register"
      # puts params.to_json
      response = http.post('/register', params)
      puts "response 1: " + response.body
    ...
    def unregister(device_token)
      puts "unregister token:" + device_token
      # puts params.to_json
      response = http.delete('/unregister', device_token: device_token)
      puts "response unregister: " + response.body
    end
